                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <?php $__currentLoopData = $subheading; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('subheading_edit',$abc->id)); ?>" class=" btn btn-dark" >Edit</a>
                                            <form method="POST" action="<?php echo e(route('Subheading.delete', $abc->id)); ?>" style="display: inline">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\strome\high_court_book\resources\views/Subheading/SubHeading.blade.php ENDPATH**/ ?>