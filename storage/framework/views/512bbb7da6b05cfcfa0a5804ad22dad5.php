                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body mx-3">
                                            ...
                                            <form method="post" action="<?php echo e(route('heading_edit')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="card-body">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body mx-3">
                                            ...
                                            <form method="post" action="<?php echo e(route('Heading.delete')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\high_court_projects\high_court_book_main_hemlata\resources\views/Heading/HeadingView.blade.php ENDPATH**/ ?>