                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('chapter_edit',$abc->id)); ?>" class=" btn btn-dark" >Edit</a>
                                            <form method="POST" action="<?php echo e(route('chapter.delete', $abc->id)); ?>" style="display: inline">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\high_court_book_aniket\resources\views/Chapter/ChapterView.blade.php ENDPATH**/ ?>