<?php $__env->startSection('content'); ?>
    <section class="content" style="margin-left: 0%;margin-top: 1%">
        <?php if(session('error')): ?>
            <script>
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'you are not allowed to add this Subhead 2 name!',
                })
            </script>
        <?php endif; ?>
        <?php if(session('success')): ?>
            <script>
                Swal.fire(
                    'Good job!',
                    'Subhead 2 name add successfully!',
                    'success'
                )
            </script>
        <?php endif; ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">SubHead 2 Table</h3>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div style="background-color: deepskyblue" class="modal-header text-center">
                                            <h4 class="modal-title w-100 font-weight-bold">Add SubHead 2</h4>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header text-center" style="background-color:lightgreen">
                                            <h4 class="modal-title w-100 font-weight-bold">Smartly edit subhead 2 data</h4>
                                        ...
                                        <div class="modal-body mx-3">
                                            ...
                                            <form method="post" action="<?php echo e(route('subsubheading_edit')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="subsubheading_id3" id="subsubheading_data3"  class="form-control" >
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header text-center" style="background-color:palevioletred">
                                            <h4 class="modal-title w-100 font-weight-bold">Smartly delete subhead2 data</h4>
                                        ...
                                        <div class="modal-body mx-3">
                                            ...
                                            <form method="post" action="<?php echo e(route('Subsubheading.delete')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <label>Select subsubhead 2 name</label>
                                                                <select name="subsubheading_id2" id="subsubheading_data2"  class="form-control" >
    ...
    <script>
        document.querySelector('#subheading_data3').onchange = function() {
            var ideee = parseInt(document.getElementById('subheading_data3').value);
            ...
            $.ajax({
                ...
                success:function (result) {
                    ...
                    $('#subsubheading_data3').html('<option disabled selected value="">---Select SubSubHeading---</option>');
                    $.each(result, function (key, value) {
                        $("#subsubheading_data3").append('<option id="subsubheading_id3" value="' + value
                            .id + '">' + value.title + '</option>');
                    });
                }
    ...
    <script>
        document.querySelector('#subheading_data2').onchange = function() {
            var ideee = parseInt(document.getElementById('subheading_data2').value);
            ...
            $.ajax({
                ...
                success:function (result) {
                    ...
                    $('#subsubheading_data2').html('<option disabled selected value="">---Select SubSubHeading---</option>');
                    $.each(result, function (key, value) {
                        $("#subsubheading_data2").append('<option id="subsubheading_id2" value="' + value
                            .id + '">' + value.title + '</option>');
                    });
                }
    ...
    <script type="text/javascript">
        ...
        $('.show_confirm').click(function(event) {
            ...
            swal({
                ...
                text: "Make sure that if you delete the Subhead 2, the Subhead 2 data will also be deleted, it will be gone forever.",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\high_court_projects\high_court_book_main_hemlata\resources\views/SubSubHeading/SubSubHeadingView.blade.php ENDPATH**/ ?>