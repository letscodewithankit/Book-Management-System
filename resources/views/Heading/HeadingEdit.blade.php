        ...
        <div class="container-sm">
            <div class="card">
                <div class="card-header">
                    ...
                    <form method="post" action="{{route('heading_update',$data[0]->id)}}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Heading Name</label>
                                <input type="text" value="{{$data[0]->title}}" class="form-control" id="edit" name="h_name" placeholder="Enter Heading name">
                            </div>
