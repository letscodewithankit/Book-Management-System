        ...
        <div class="container-sm">
            <div class="card">
                <div class="card-header">
                    ...
                    <form method="post" action="{{route('chapter_update',$data[0]->id)}}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Chapter Name</label>
                                <input type="text" value="{{$data[0]->title}}" class="form-control" id="edit" name="c_name" placeholder="Enter chapter name">
                            </div>
