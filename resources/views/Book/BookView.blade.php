                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                @foreach($data as $abc)
                                    <tr>
                                        ...
                                        <td>{{$abc->title}}</td>
                                        <td>
                                            <a href="{{route('edit_book_name',$abc->id)}}" class=" btn btn-dark show_edit" >Edit</a>
                                            <form method="POST" action="{{ route('users.delete', $abc->id) }}" style="display: inline">
                                                @csrf
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body mx-3">
                                            ...
                                            <form method="post" action="{{route('book_save')}}">
                                                @csrf
                                                <div class="card-body">
